...
.. note:: Refer to :doc:`/guides/authoring/creating_walls` for step-by-step guidance on wall creation.
...
.. note:: Refer to :doc:`/guides/authoring/opening` for detailed instructions
